...
def params_reqired():
    ...
    return [ # обязательные параметры
        {'name': 'Algo', 'type': 'str', 'example': 'XGB / LogReg', 'descr': 'Название лагоритма для предсказания (см. подробности внизу этой страницы)'},
        ...
        {'name': 'IsActiveMember', 'type': 'int', 'example': '1 -актив, 0 -нет', 'descr': 'Является ли клиент активным'},
